      ...
      <div className="lay">
        <section className="row footer-header">
          ...
          <section className="col-12 col-desksm-4 col-desk-3 footer-header__redes">
            <a href="https://www.facebook.com/lanacion" target="_blank" rel="noreferrer"><i className="icon-facebook"></i></a>
            <a href="https://twitter.com/LANACION" target="_blank" rel="noreferrer"><i className="icon-twitter"></i></a>
            <a href="https://www.instagram.com/lanacioncom/" target="_blank" rel="noreferrer"><i className="icon-instagram"></i></a>
            <a href="http://servicios.lanacion.com.ar/herramientas/rss/ayuda" target="_blank" rel="noreferrer"><i
                className="icon-rss"></i></a>
          </section>
          <section className="col-12 col-desksm-4 col-desk-3 footer-header__app">
            <a href="https://play.google.com/store/apps/details?id=app.lanacion.activity&hl=es_419" target="_blank"
              className="app_play" rel="noreferrer">
                ...
                <g fill="none" fillRule="evenodd">
                  ...
                  <g fillRule="nonzero">
                    ...
                    <path fill="url(#b)"
                      ...
                      transform="translate(17.378 7.864)" />
                    <path fill="url(#c)" d="M13.208 13.094l-3.18-3.209L.639 19.36c.347.373.92.418 1.568.046l11-6.312"
                      transform="translate(17.378 7.864)" />
                    <path fill="url(#d)" d="M13.208 6.676L2.199.365C1.551-.008.98.038.632.411l9.396 9.474 3.18-3.209z"
                      transform="translate(17.378 7.864)" />
                    <g fill="#000">
                      <path
            ...
            <a href="https://apps.apple.com/ar/app/la-nacion/id410689702" target="_blank" className="app_ios" rel="noreferrer">
              <svg xmlns="http://www.w3.org/2000/svg" width="120" height="35" viewBox="0 0 120 35">
                <g fill="none" fillRule="evenodd">
                  <rect width="119.862" height="35" fill="#5A5A5A" rx="3" />
        ...
        <section className="row footer-sitio">
          <section className="col-desksm-9 col-deskxl-8 footer-sitio__links">
            <a href="http://especiales.lanacion.com.ar/varios/mapa-sitio/index.html" className="item_link">Mapa del
              sitio</a>
            ...
            <a href="https://suscripciones.lanacion.com.ar/suscribirme/" className="item_link">Suscribirse al diario
              impreso</a>
          </section>
          <section className="col-desksm-3 col-deskxl-4 footer-sitio__captcha">
            <p>Protegido por re CAPTCHA: <a href="https://policies.google.com/terms?hl=es-419" target="_blank"
                className="condition" rel="noreferrer">Condiciones</a> <a href="https://policies.google.com/privacy?hl=es-419"
                target="_blank" className="private" rel="noreferrer">Privacidad</a></p>
        ...
        <section className="row footer-copyright">
          <section className="col-desksm-6 col-desk-6 footer-copyright__fiscal">
            <p><img src="https://static.glanacion.com/v2/ln/img/gda.jpg" alt="gda" className="img_gda"/> Miembro de GDA.
              Grupo de Diarios América <a href="https://serviciosweb.afip.gob.ar/clavefiscal/qr/publicInfoD.aspx"
                target="_blank" rel="noreferrer"><img src="https://static.glanacion.com/v2/ln/img/data.jpg" alt="Data fiscal"
                  className="img_data-fiscal"/></a></p>
