                        ...
                        <li className="com-item">
                            <article className="mod-caja-nota --border ohlala">
                                <section id="" className="cont-figure">
                                    <a href="nota-receta.asp" className="figure">
                                        <picture id="" className="content-pic picture">
                                            <img src="https://bucket1.glanacion.com/anexos/fotos/22/3054322h600.jpg" alt=""
                                                className="content-img" />
                                        </picture>
                                    </a>
                                </section>
                                <div className="mod-caja-nota__descrip">
                                    <h2 className="com-title-acu"><a href="nota-receta.asp"><b>La escuela.</b> que tiene de escudo al Che
                                        Guevara y donde izan la bandera de Cuba</a></h2>
                                </div>
                            </article>
                        </li>
                        <li className="com-item">
